...
export function TaskDetailView(props: TaskDetailViewProps) {
  ...
  // markDone / markInProgress live on MilestoneManagement.task, not under
  // .detail; through `t` the status button rendered raw key paths.
              ...
              >
                {done ? (
                  ...
                  <>
                    ...
                    />
                    <span>
                      {inProgress ? tTask("markDone") : tTask("markInProgress")}
                    </span>
                  </>
                )}
              </Button>
...
function ImagesGallery({
  ...
  return (
    <section className="flex flex-col gap-1.5">
      <h3 className="flex items-center gap-1 text-2xs font-medium uppercase tracking-wide text-muted-foreground">
