...
export function DraggableMap({
  ...
  return (
    ...
    >
      ...
      <span
        className={cn(
          "pointer-events-none absolute left-2 top-2 rounded bg-background/90 px-2 py-1 text-xs text-muted-foreground transition-opacity",
      ...
      <span className="pointer-events-none absolute bottom-0 right-0 bg-white/75 px-1 text-xs leading-tight text-black">
