...
function ProviderEngagementActionsInner({
  ...
  return (
    <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
      {showAwaiting ? (
        <span className="inline-flex shrink-0 items-center gap-1 rounded-full border border-info/30 bg-info/10 px-2 py-0.5 text-[11px] font-medium text-info-muted-foreground">
