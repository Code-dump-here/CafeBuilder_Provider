...
function ProviderEngagementActionsInner({
  ...
  if (isLoading && !engagement) {
    return (
      <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
        <span
          aria-hidden
          className="inline-flex shrink-0 items-center gap-1 rounded-md border border-border/40 bg-card/40 px-1.5 py-1 text-xs text-muted-foreground"
        >
  ...
  return (
    <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
      {showAwaiting ? (
        <span className="inline-flex shrink-0 items-center gap-1 rounded-full border border-info/30 bg-info/10 px-2 py-0.5 text-2xs font-medium text-info-muted-foreground">
