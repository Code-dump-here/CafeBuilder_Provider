        ...
        <span className="flex items-start gap-2">
          ...
          <span className="flex min-w-0 flex-1 flex-col gap-0.5">
            <span className="flex items-center justify-between gap-2">
              <span className="font-mono text-2xs font-semibold uppercase tracking-wide text-muted-foreground">
                {versionLabel}
              </span>
            ...
            {snapshot.snapshotKind === "revision" && snapshot.reason ? (
              <span className="mt-0.5 rounded-sm border-l-2 border-danger/50 bg-danger/5 py-0.5 pl-1.5 text-2xs leading-relaxed text-foreground/80">
                {snapshot.reason}
              </span>
            ) : null}
