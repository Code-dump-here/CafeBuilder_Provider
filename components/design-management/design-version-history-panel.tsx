        ...
        <span className="flex items-start gap-2">
          ...
          <span className="flex min-w-0 flex-1 flex-col gap-0.5">
            ...
            {snapshot.snapshotKind === "revision" && snapshot.reason ? (
              <span className="mt-0.5 rounded-sm border-l-2 border-rose-400/60 bg-rose-50/60 py-0.5 pl-1.5 text-[11px] leading-relaxed text-foreground/80 dark:bg-rose-950/20">
                {snapshot.reason}
              </span>
            ) : null}
