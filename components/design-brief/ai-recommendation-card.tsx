    ...
    <div className="flex flex-col gap-3">
      <div className="flex items-start gap-2 rounded-md border border-destructive/40 bg-destructive/10 p-3 text-xs text-destructive">
        ...
        <div className="min-w-0 flex-1">
          ...
          {error ? (
            <pre className="mt-1 max-h-32 overflow-auto whitespace-pre-wrap wrap-break-word font-mono text-xs leading-relaxed text-destructive/90">
              {error}
            </pre>
          ) : null}
          ...
          <ol className="flex flex-col gap-1.5">
            {rec.customerFlow!.map((step, i) => (
              ...
              >
                <span
                  aria-hidden
                  className="mt-0.5 inline-flex size-5 shrink-0 items-center justify-center rounded-full bg-primary/10 text-xs font-semibold text-primary"
                >
                  {i + 1}
                </span>
                <div className="min-w-0 flex-1">
