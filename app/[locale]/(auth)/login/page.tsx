        ...
        <div className="relative z-10 flex flex-col items-center gap-8">
          <div className="relative" aria-hidden="true">
            ...
            >
              {/* Cup body */}
              <path
                d="M40 70 L50 160 C52 172 60 180 80 180 L120 180 C140 180 148 172 150 160 L160 70 Z"
              ...
              <ellipse
                ...
                rx="60"
                ry="14"
                fill="rgba(180,100,20,0.4)"
                stroke="rgba(251,191,36,0.3)"
                strokeWidth="1"
              />
              {/* Latte art swirl */}
              <path
                d="M80 68 C85 62 95 62 100 68 C105 74 115 74 120 68"
              ...
              {/* Handle */}
              <path
                d="M160 90 C178 90 185 110 178 130 C172 148 158 148 150 140"
                stroke="rgba(251,191,36,0.4)"
                strokeWidth="1.5"
                fill="none"
                strokeLinecap="round"
              ...
              />
              <path
                d="M100 50 C97 37 105 25 101 13"
              ...
              />
              <path
                d="M125 55 C122 42 130 30 126 18"
                stroke="rgba(251,191,36,0.3)"
                strokeWidth="1.5"
                fill="none"
                strokeLinecap="round"
