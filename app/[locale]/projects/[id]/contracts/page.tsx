...
function CreateContractDialog({
  ...
  // Seed once per quotation choice and keep the user's later edits. Keyed on
  // the id rather than the object, so a refetch returning an equal quotation
  // doesn't overwrite what they typed. Adjusted during render, like the
  // resets above, instead of setState in an effect.
  useResetOnChange(selectedQuotation?.id, () => {
    if (selectedQuotation) setAgreedValue(String(selectedQuotation.totalAmount));
  });
